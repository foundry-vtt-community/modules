...
## [Popout!](Foundry VTT Modules (Universal)/fvtt-module-popout.md)
...
## [Grid Scaler](Foundry VTT Modules (Universal)/scaleGrid.md)
...
## [Infinite Folders](Foundry VTT Modules (Universal)/fvtt-module-infinite-folders.md)
...
## [Item Sounds](Foundry VTT Modules (Universal)/item-sounds.md)


## [Journal Enhancer](Foundry VTT Modules (Universal)/journal-enhancer.md)
...
## [Layer Hotkeys](Foundry VTT Modules (Universal)/layer-hotkeys.md)
This module adds hotkeys for switching layers and the active tool in canvas.

## [Message Age Restriction](Foundry VTT Modules (Universal)/messageagerestriction.md)
...
## [Permission Viewer](Foundry VTT Modules (Universal)/fvtt-module-permission-viewer.md)
...
## [SVG Loader](Foundry VTT Modules (Universal)/svg-loader.md)


## [Token Randomizer](Foundry VTT Modules (Universal)/token-randomizer.md)
...
## [Better NPC Sheet 5e](Foundry VTT Modules for DnD 5E:/BetterNPCSheet5e.md)
...
## [Beyond 20](Foundry VTT Modules for DnD 5E:/Beyond20.md)
...
## [Chat Damage Buttons](Foundry VTT Modules for DnD 5E:/foundry-vtt---chat-damage-buttons.md)
...
## [DnD Beyond Character Importer](Foundry VTT Modules for DnD 5E:/foundry-vtt-modules.md)
This module allows you to import character data from DnD Beyond into Foundry Virtual Tabletop.

## [Encumbrance Variant](Foundry VTT Modules for DnD 5E:/foundry-vtt---encumbrance-variant-5e.md)
...
## [Favourite Item Tab](Foundry VTT Modules for DnD 5E:/favtab.md)
...
## [FVTT-Party](Foundry VTT Modules for DnD 5E:/fvtt-party.md)
...
## [Item Sheet Buttons](Foundry VTT Modules for DnD 5E:/foundry-vtt---item-sheet-buttons.md)
...
## [Loot Sheet NPC (5e)](Foundry VTT Modules for DnD 5E:/foundry-vtt---loot-sheet-npc.md)
...
## [NPC Browser](Foundry VTT Modules for DnD 5E:/npc-browser.md)
...
## [Polymorpher](Foundry VTT Modules for DnD 5E:/polymorpher.md)
...
## [R20 Converter](Foundry VTT Modules for DnD 5E:/R20 Converter.md)
...
## [Roll20 NPC Importer, for 5e](Foundry VTT Modules for DnD 5E:/roll20npcimporter.md)
...
## [Spell Browser](Foundry VTT Modules for DnD 5E:/Spell-Browser.md)
...
## [SRD Bestiary Module](Foundry VTT Modules for DnD 5E:/SRD Bestiary Module.md)
...
## [aDnD5e](Foundry VTT Modules (Defunct)/adnd5e.md)
